...
- [ ] **E07: Issue Deep-Dive** — For each critical issue, fetch full detail including CVEs, fix suggestions, severity change reasons. Write enriched report to experiments/
- [ ] **E08: Dependency Tree Mapper** — Map SBOM dependency chains (direct → transitive) and identify which transitive deps introduce the most risk
